...
```{r}
library(brms)
bayes_vitals = brm(bmi ~ timepoints_vitals + bp_systolic + gender + ageatmodelenrollment + (timepoints_vitals | universal_id), data = CIL_CKY_vitals_complete, chains = 3)
summary(bayes_vitals)
plot_model(bayes, type = "pred", terms = c("timepoints_vitals"))
icc(bayes)
