...
model_1_auto = lmer(BAHCS_10Total ~ FollowUpTimePoint + Substance_composite + Ill_West + KY +  (FollowUpTimePoint | Universal_ID), weights = varIdent(form= ~ 1 | FollowUpTimePoint), correlation = corAR1(),  data = HCS)
